...
public class MultiLanguageExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        page.drawTextBox(50, 712, 450, 14, "Helvetica", 11,
                "Demonstrating text output in multiple languages.");
        ...
        page.drawTextBox(70, 362, 450, 16, "Helvetica", 13,
                "Ola Mundo - criacao de PDF simples e eficiente.");
        ...
        page.drawTextBox(50, 268, 500, 30, "Helvetica", 10,
                "Base-14 fonts support ASCII text natively. " +
                "For full Unicode (Cyrillic, CJK, Arabic), see PDFixa Pro.");
